...
export class AddSqlFunctions1740037227669 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            DROP FUNCTION IF EXISTS get_collections_by_keyword;
        `);

    await queryRunner.query(`
            DROP FUNCTION IF EXISTS get_filtered_collections;
        `);
  }
}
